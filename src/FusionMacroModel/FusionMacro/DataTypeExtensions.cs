...
namespace FusionMacro
{
    internal static class DataTypeExtensions
    {
        ...
        public static object ToCLRDateTime(this int day)
        {
            if (day == 99999)
            {
        ...
        public static object ToCLRDateTime(this short day)
        {
            return ToCLRDateTime((int)day);
        }
        ...
        public static object ExtractValueFromSophisCell(this SSMCellValue cv, SSMCellStyle cs)
        {
            switch (cs.kind)
            {
                ...
                case NSREnums.eMDataType.M_dDateTime:
                    ...
                    return ToCLRDateTime(cv.integerValue);
